...
public class SampleFileUpload {
    ...
    public static void main(String args[]){
        ...
        File file = new File ("D:\\subaccount.txt") ;

        String response = fileUpload.executeMultiPartRequest("http://localhost:8080/api/multipartupload/uploadpart", file, file.getName(), "File Upload test subaccount.txt description") ;
